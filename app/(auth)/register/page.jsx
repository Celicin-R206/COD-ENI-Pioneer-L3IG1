...
const login = () => {
  const { register, handleSubmit,reset, formState: { isSubmitting,errors }, watch } = useForm();
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-groupe">
            <span>
              ...
              <input type="text" name="name" id="name" {...register('name', { required: 'entrez votre nom!'})} />
            </span>
            <span>
          ...
          <div className="form-groupe">
            <span>
                ...
                <input type="text" name="lieuNaiss" id="lieuNaiss" {...register('lieuNaiss', { required: 'Entrez votre lieu de naissance!'})}/>
            </span>
            <span>
            ...
            <span>
                ...
                <input type="text" name="address" id="address" {...register('address', { required: 'Entrez votre addresse!'})}/>
            </span>
            <div className="form-groupe">
              <span className="password">
                  <label htmlFor="password">Mot de passe</label>
                  <input type="password" name="password" id="password" {...register('password', { required: 'Votre mot de passe!'})}/>
              </span>
              <span className="password_confirm">
                  <label htmlFor="password_confirm">Confirmer mot de passe</label>
                  <input type="password" name="password_confirm" 
                  id="password_confirm" {...register('password_confirm', { required: 'Entrez pour confirmer mot de passe!'})}/>
              </span>
            </div>
            <span className="password">
                ...
                <div className="flex cin_copie">
                  ...
                  <input type="cin_number" name="cin_number" id="cin_number" {...register('cin_copie', { required: 'Ce champest requis!'})}/>
                </div>
            </span>
            <span>
